            ...
            <div class="tabbed-head">
                <ul class="nav nav-tabs primary-background" role="tablist">
                    <li role="presentation" class="tab tab-popular active">
                        <a href="#ms-popular" aria-controls="<?php esc_attr_e('Popular', 'minimal-grid'); ?>" role="tab" data-toggle="tab" class="primary-bgcolor">
                            <span class="tab-icon">
                    ...
                    <li class="tab tab-recent">
                        <a href="#ms-recent" aria-controls="<?php esc_attr_e('Recent', 'minimal-grid'); ?>" role="tab" data-toggle="tab" class="primary-bgcolor">
                            <span class="tab-icon">
