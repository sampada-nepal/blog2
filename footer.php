    ...
    ?>
        <div class="site-copyright">
            ...
            if ($enable_footer_credit) {
                printf(esc_html__('Theme: %1$s by %2$s', 'minimal-grid'), '<a href="https://www.thememattic.com/theme/minimal-grid/" target = "_blank" rel="designer">Minimal Grid</a>', '<a href="https://thememattic.com/" target = "_blank" rel="designer">Thememattic</a>');
            }
            ?>
        </div>
    <?php endif;?>
